...
export default function App() {
  ...
  const handleSave = () => {
    ...
    const newRecord = {
      ...
      ownerSurname,
      weight,
      doses: doses.filter(d => activeDrugs.includes(d.id)),
      meta: lockedMeta,
        ...
        {records.map((rec,i)=>(
          <div key={i} style={recordCard}>
            <div style={{display:"flex",justifyContent:"space-between"}}>
              ...
              <button onClick={()=>handleDelete(i)} style={dangerBtn}>✕</button>
            </div>
